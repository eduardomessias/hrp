                ...
                <div className="ml-0 md:ml-12 lg:w-2/3 sticky">
                    <div className="container mx-auto w-full h-full">
                        <div className="relative wrap overflow-hidden p-10 h-full">
                            ...
                            `}</style>
                            <div className="border-2-2 border-yellow-555 absolute h-full border rightBorder"></div>
                            <div className="border-2-2 border-yellow-555 absolute h-full border leftBorder"></div>
                            ...
                            <Image className="mx-auto -mt-36 md:-mt-36" src="/rocket-lady.png" width={402} height={277} />
                        </div>
                    </div>
                </div>
            </div>
