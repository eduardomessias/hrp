                ...
                <div className="ml-0 md:ml-12 lg:w-2/3 sticky">
                    <div className="container mx-auto w-full h-full">
                        <div className="relative wrap overflow-hidden p-10 h-full">
                            <div className="border-2-2 absolute h-full border rightBorder"></div>

                            <div className="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
                                <Image className="mx-auto -mt-36 md:-mt-36" src="/assets/openDoodles/readingSide.svg" width={402} height={277} />
                            ...
                            <Image className="mx-auto -mt-36 md:-mt-36" src="/assets/openDoodles/characterSwinging.svg" width={768} height={640} />
